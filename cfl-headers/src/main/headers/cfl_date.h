...
extern void cfl_date_getDate(const CFL_DATEP date, CFL_INT16 *year, CFL_UINT8 *month, CFL_UINT8 *day);
extern void cfl_date_getTime(const CFL_DATEP date, CFL_UINT8 *hour, CFL_UINT8 *min, CFL_UINT8 *sec, CFL_UINT16 *millis);
extern void cfl_date_getDateTime(const CFL_DATEP date, CFL_INT16 *year, CFL_UINT8 *month, CFL_UINT8 *day, CFL_UINT8 *hour, CFL_UINT8 *min, CFL_UINT8 *sec, CFL_UINT16 *millis);
