...
#define CFL_SQL_TO_STRING(sql, str)                                            \
  ((CFL_SQLP)sql)->to_string((CFL_SQLP)sql, str)
...
typedef CFL_SQL_QUERYP (*CFL_SQL_QUERY_ITEMS_FUN)(CFL_SQL_QUERYP query,
                                                  CFL_SQLP first, ...);
typedef CFL_SQL_QUERYP (*CFL_SQL_QUERY_ITEM_FUN)(CFL_SQL_QUERYP query,
                                                 CFL_SQLP item);
typedef CFL_SQL_QUERYP (*CFL_SQL_QUERY_HINT_FUN)(CFL_SQL_QUERYP query,
                                                 CFL_STRP value);
typedef CFL_SQL_QUERYP (*CFL_SQL_QUERY_UPDATE_FUN)(CFL_SQL_QUERYP query,
                                                   CFL_UINT16 wait);

typedef CFL_SQL_INSERTP (*CFL_SQL_INS_ITEM_FUN)(CFL_SQL_INSERTP ins,
                                                CFL_SQLP table);
typedef CFL_SQL_INSERTP (*CFL_SQL_INS_ITEMS_FUN)(CFL_SQL_INSERTP ins,
                                                 CFL_SQLP first, ...);
typedef CFL_SQL_INSERTP (*CFL_SQL_INS_ITEM2_FUN)(CFL_SQL_INSERTP ins,
                                                 CFL_SQLP item1,
                                                 CFL_SQLP item2);

typedef CFL_SQL_UPDATEP (*CFL_SQL_UPD_ITEM_FUN)(CFL_SQL_UPDATEP upd,
                                                CFL_SQLP item);
typedef CFL_SQL_UPDATEP (*CFL_SQL_UPD_ITEM2_FUN)(CFL_SQL_UPDATEP upd,
                                                 CFL_SQLP item1,
                                                 CFL_SQLP item2);

typedef CFL_SQL_DELETEP (*CFL_SQL_DEL_ITEM_FUN)(CFL_SQL_DELETEP del,
                                                CFL_SQLP item);
typedef CFL_SQL_DELETEP (*CFL_SQL_DEL_ITEM2_FUN)(CFL_SQL_DELETEP del,
                                                 CFL_SQLP item1,
                                                 CFL_SQLP item2);

typedef CFL_SQL_BLOCKP (*CFL_SQL_BLOCK_ITEM_FUN)(CFL_SQL_BLOCKP block,
                                                 CFL_SQLP item);
typedef CFL_SQL_BLOCKP (*CFL_SQL_BLOCK_PRAGMA_FUN)(CFL_SQL_BLOCKP block,
                                                   CFL_STRP item);
typedef CFL_SQL_BLOCKP (*CFL_SQL_BLOCK_CHAR_PRAGMA_FUN)(CFL_SQL_BLOCKP block,
                                                        char *item);
typedef CFL_SQL_BLOCKP (*CFL_SQL_BLOCK_VAR_FUN)(CFL_SQL_BLOCKP block,
                                                CFL_STRP varName,
                                                CFL_SQLP varType,
                                                CFL_SQLP varValue);
typedef CFL_SQL_BLOCKP (*CFL_SQL_BLOCK_CHAR_VAR_FUN)(CFL_SQL_BLOCKP block,
                                                     char *varName,
                                                     CFL_SQLP varType,
                                                     CFL_SQLP varValue);
